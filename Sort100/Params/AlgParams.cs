...
namespace Sort100.Params
{
    ...
    public sealed class AlgParams
    {
        ...
        /// <summary>
        /// Количество InMemory сортировщиков небольших пачек данных. Для нераспараллеливаемых алгоритмов сортировки
        ...
        /// <summary>
        /// Максимальное количество объектов в чанке. Используется для эффективного распределения памяти под данные чанка.
        /// </summary>
